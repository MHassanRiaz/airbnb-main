...
amenities_data.each do |data|
  Amenity.find_or_create_by!(name: data[:name]) do |amenity|
...
image_indices = (1..12).to_a.sample(7)
image_indices.each do |img_i|
  image_path = Rails.root.join("db/images/property_#{img_i}.png")
  File.open(image_path) do |file|
    property.images.attach(io: file, filename: "property_#{img_i}.png")
  end
end
